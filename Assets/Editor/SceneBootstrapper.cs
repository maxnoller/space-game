...
namespace SpaceGame.Editor
{
    ...
    public class SceneBootstrapper
    {
        ...
        const string k_LoadBootstrapSceneOnPlay = "AllOverTheUniverse/Load Bootstrap Scene On Play";
        const string k_DoNotLoadBootstrapSceneOnPlay = "AllOverTheUniverse/Don't Load Bootstrap Scene On Play";
